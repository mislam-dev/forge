...
| POST   | /access-control/permissions     | Create permission   |
| PUT    | /access-control/permissions/:id | Update permission   |
| DELETE | /access-control/permissions/:id | Delete permission   |
...
```json
GET /access-control/permissions?page=1&per_page=10
```
...
```json
PUT /access-control/permissions/18d1071f-9f9d-55d2-a53d-4115g6b7d6c7
{
  "key": "Update User",
  "value": "update-user",
...
```json
DELETE /access-control/permissions/18d1071f-9f9d-55d2-a53d-4115g6b7d6c7
```
