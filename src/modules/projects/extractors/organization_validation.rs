...
pub type RequiredOrgViewer = OrgValidationOptional<OrgOnlyViewer>;
pub type RequiredOrgAdmin = OrgValidationOptional<OrgOnlyAdmin>;
pub type RequiredOrgOwner = OrgValidationOptional<OrgOnlyOwner>;
pub type RequiredOrgEditor = OrgValidationOptional<OrgOnlyEditor>;
